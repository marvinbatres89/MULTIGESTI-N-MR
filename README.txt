MULTIGESTIÓN MR V1.4.5

Diagnóstico seguro de nube: muestra sesión activa, usuario abreviado, correo enmascarado, negocios devueltos por Supabase y tipo de acceso. Nunca muestra contraseñas, tokens ni claves.
...
V1.4.4 - CARGA RESISTENTE DE NEGOCIOS
- La consulta de negocios es prioritaria e independiente.
- Fallos de movimientos, agenda, miembros o perfil ya no vacían Mis negocios.
- Supabase continúa siendo la fuente de verdad durante una sesión autenticada.
- Se actualizó la caché PWA para forzar la carga de la versión corregida.

    ...
    if (cloudActive()) {
      try {
        ...
        */
        ...
        /*
          RECUPERACIÓN R1:
          Si existe una sesión cloud pero falla una consulta remota,
          NO mezclar ni sustituir Supabase con negocios antiguos de IndexedDB.
          Esto evita que reaparezcan negocios locales obsoletos.
        */
        businesses = [];
        movements = [];
        tasks = [];
